SELECT oc.pickup_at        AS `Pickup Date`,
       oc.reference_number as 'Reference Number',
    oc.tracking_id      as 'TrackingId',
    oc.customer_account as 'Account Number',
    cc.name             as 'Account Name',
    oc.product_code,
       oc.origin_country,
       oc.origin_city,
...
WHERE oc.pickup_at BETWEEN (UNIX_TIMESTAMP(DATE_SUB(CURDATE(), INTERVAL 1 DAY)) - 8 * 3600) *
  ...
  AND oc.customer_account IN (
                              ...
                              'AJEX1578', 'AJCN79', 'AJCN80','AJCN514','AJCN81','AJEX1515','AJEX1616','AJCN589','AJCN88','AJCN83', 'AJCN91','AJCN86','AJCN93','AJEX0218','AJEX1770','AJCN96','AJCN55','AJCN95',
